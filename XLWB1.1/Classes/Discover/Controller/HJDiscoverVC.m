...
@interface HJDiscoverVC ()

@end

@implementation HJDiscoverVC

- (void)viewDidLoad {
    [super viewDidLoad];
    HJSearchBar *searchBar=[[HJSearchBar alloc]initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 35)];
